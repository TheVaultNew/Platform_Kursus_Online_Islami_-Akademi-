      ...
      >
        ...
        >
          ...
          <div v-else-if="currentStep === 2" class="p-5 sm:p-7 space-y-5 overflow-y-auto flex-1">
            ...
            <div v-else class="p-4 sm:p-5 rounded-2xl bg-cream-100 border border-gold-500/40 space-y-4">
              <div class="space-y-1 text-center sm:text-left">
                <span class="px-3 py-1 rounded-full bg-gold-400 text-emerald-950 font-bold text-[10px] sm:text-[11px] uppercase tracking-wider shadow-sm inline-block">
